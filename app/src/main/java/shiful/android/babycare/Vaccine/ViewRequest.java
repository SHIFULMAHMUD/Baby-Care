...
public class ViewRequest extends AppCompatActivity {
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        loading.dismiss();
                        Toast.makeText(shiful.android.babycare.Vaccine.ViewRequest.this, "Network Error!", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void showJSON(String response) {
        ...
        try {
            ...
            if (result.length()==0)
            {
                Toast.makeText(shiful.android.babycare.Vaccine.ViewRequest.this, "Please Add Your Baby!", Toast.LENGTH_LONG).show();
